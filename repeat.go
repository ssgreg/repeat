...
func WrapOnce(wop OpWrapper) Repeater {
	return &stdRepeater{Forward, wop}
}

// func NewRepeaterExt(wop, woop, OpWrapper, c, d Operation) {
...
func Cpp(c, d Operation) Repeater {
	return &stdRepeater{Forward, WrWith(c, func(e error) error {
		_ = FnPanic(d)(e)
...
func With(c, d Operation) Repeater {
	return &stdRepeater{Forward, WrWith(c, d)}
}
